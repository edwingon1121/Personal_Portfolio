...
const Download = () => {
    return (
        <div id='download'>
            <DownloadContain src={'https://d1bx69z06fa2ip.cloudfront.net/plan.svg'} title={'Resume'} buttonText={'View Resume'} href={'https://d1bx69z06fa2ip.cloudfront.net/Resume.pdf'}/>
